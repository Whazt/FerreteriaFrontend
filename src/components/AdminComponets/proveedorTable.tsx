...
export default function ProveedorTable({ proveedores, loading, onEdit, onDelete }: Props) {
    const [itemAEliminar, setItemAEliminar] = useState<Proveedor | null>(null);
    ...
    if (proveedores.length === 0) return <div className="p-4 text-center text-gray-500">No hay proveedores registrados.</div>;
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-500">
                                Vas a eliminar a <strong>"{itemAEliminar.nombre}"</strong>. Esta acción no se puede deshacer.
                            </p>
                        </div>
